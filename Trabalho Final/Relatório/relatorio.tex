...
Este trabalho tem como objetivo desenvolver um modelo de rede neural convolucional capaz de classificar imagens em diferentes categorias representando graus de Alzheimer, a partir de uma base de dados pública.
...
O modelo foi treinado por 25 épocas com \textit{batch size} de 32, utilizando o otimizador Adam.
